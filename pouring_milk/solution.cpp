...
void find_fill(int fill_list[], int vol_list[], int from, int to) {
  ...
  cout << "\nstepping in..." << endl;
  find_fill((int[]){fill_list[0], fill_list[1], fill_list[2]},
            (int[]){vol_list[0], vol_list[1], vol_list[2]}, to, third);
  find_fill((int[]){fill_list[0], fill_list[1], fill_list[2]},
            (int[]){vol_list[0], vol_list[1], vol_list[2]}, from, third);
  find_fill((int[]){fill_list[0], fill_list[1], fill_list[2]},
            (int[]){vol_list[0], vol_list[1], vol_list[2]}, third, from);
  find_fill((int[]){fill_list[0], fill_list[1], fill_list[2]}, (int[]) {vol_list[0], vol_list[1], vol_list[2]}, third,
            to);
  cout << "\nstepping out" << endl;
}
